...
> {
  ...
  constructor(
    @inject('datasources.mongooseDB') dataSource: MongooseDbDataSource, @repository.getter('PedidoRepository') protected pedidoRepositoryGetter: Getter<PedidoRepository>,
  ) {
